...
def get_alI_II(nn0,sig0,sig1):
    ...
    tau_max_rouse2 = nn0**2*(24-2)**2/np.pi**2
    al_II = Zeta_Dist(Max_Zeta,nn0,0,sig0)**(1-sig1)/tau_max_rouse2
    al_III =Max_Zeta/tau_max_rouse2
    sumC=sumC_n_j(nn0,sig0,sig1,Max_Zeta)
    al_I = sumC/2**nn0
...
def solve_sig_beta(al_I,al_II,n):
    ...
    for i in range(40):
        ...
        for sig in SIG_ALL:
            ...
            sumC=sumC_n_j(n,sig,bet,Max_Zeta)
            al_I_t=sumC/2**n
