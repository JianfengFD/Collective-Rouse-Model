...
# NOTE: The algorithm used in this code differs slightly from the one described in the CRD paper 
# to enhance the program's robustness. In this version, the model parameters beta and sigma 
# are automatically determined by the program instead of being fitted to the experimental curve. 
# This modification makes the program more powerful in prediction.
# The codes for reproducing FIG 3 from the CRD paper are provided in the FIG3 directory.
